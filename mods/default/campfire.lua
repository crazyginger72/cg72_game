...
minetest.register_node("default:campfire_active", {
...
minetest.register_abm({
	nodenames = {"default:campfire","default:campfire_active"},
	interval = 1.0,
	chance = 1,
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		if meta:get_float("fuel_time") < meta:get_float("fuel_totaltime") then
			...
			hacky_swap_node(pos,"default:campfire_active")
		...
		if fuel.time <= 0 then
			...
			hacky_swap_node(pos,"default:campfire")
			meta:set_string("formspec", default.furnace_inactive_formspec)
			return
		end

...
minetest.register_node("default:sunflower_m", {
	...
	selection_box = {
		type = "fixed",
		fixed = {
				{-0.125, -0.5, 0, 0.1875, 0.5, 0.3125}, -- NodeBox1
				{0.0625, 0.13964, 0.137614, 0.309309, 0.166667, 0.167644}, -- NodeBox2
				{0.1875, 0.125, 0.125, 0.5, 0.1875, 0.1875}, -- NodeBox3
				{0.213213, 0.125, 0.0625, 0.477477, 0.1875, 0.25}, -- NodeBox4
				{0.207207, -0.375, 0.0625, 0.495495, -0.3125, 0.25}, -- NodeBox5
...
minetest.register_node("default:sunflower_head", {
	...
	drop = {
		items = {
			...
			{ items = {'default:dye_yellow'}, },
			{ items = {'default:due_yellow'}, rarity = 10,},
			{ items = {'default:dye_green'}, rarity = 25,},
		},
	},
	drawtype = "nodebox",
	node_box = {
		...
		fixed = {
				...
				{-0.0625, -0.1875, 0.09, 0.125, 0.5, 0.091}, -- NodeBox19
				{-0.3125, 0.0625, 0.09, 0.375, 0.25, 0.091}, -- NodeBox20
				{-0.1875, -0.125, 0.09, 0.25, 0.4375, 0.091}, -- NodeBox21
				{-0.25, -0.0625, 0.09, 0.3125, 0.375, 0.091}, -- NodeBox22
		}
	},
	selection_box = {
		type = "fixed",
		fixed = {
				{-0.125, -0.5, 0, 0.1875, 0.0625, 0.3125}, -- NodeBox1
				{0.207207, -0.375, 0.0625, 0.495495, -0.3125, 0.25}, -- NodeBox5
				{0.1875, -0.375, 0.125, 0.5, -0.3125, 0.1875}, -- NodeBox6
				{0.0625, -0.355856, 0.146623, 0.1875, -0.331832, 0.167644}, -- NodeBox7
				{-0.4375, -0.25, 0.125, -0.125, -0.1875, 0.1875}, -- NodeBox8

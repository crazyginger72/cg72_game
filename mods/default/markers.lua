...
dofile(minetest.get_modpath("default").."/markers_areas.lua");

dofile(minetest.get_modpath("default").."/marker_stone.lua");

dofile(minetest.get_modpath("default").."/land_title_register.lua");
...
markers.marker_on_receive_fields = function(pos, formname, fields, sender)
   ...
   if( error_msg ~= nil ) then
      minetest.show_formspec( name, "default:mark", markers.get_marker_formspec(sender, pos, error_msg));
      return;
   end
   ...
   if not canAdd then
      ...
      minetest.show_formspec( name, "default:mark", markers.get_marker_formspec(sender, pos, errMsg));
      return
   end
   ...
   minetest.show_formspec( name, "default:mark", markers.get_marker_formspec(sender, pos, nil));
end
...
markers.form_input_handler = function( player, formname, fields)
   ...
   elseif( formname == "default:info"
      ...
      -- TODO
--      minetest.chat_send_player('singleplayer','default:INFO WITH '..minetest.serialize( fields ));
...
minetest.register_node("default:mark", {
	description = "Marker",
	...
	node_box = {
        ...
        print(ctrl.RMB.." [dig] was ctrl.RMB!")
        if ctrl.RMB then
          return
        end
    ...
    print(ctrl.LMB.." [right_click] was ctrl.LMB!")
    if ctrl.LMB then
      return
    end

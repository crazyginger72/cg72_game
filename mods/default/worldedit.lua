...
dofile(minetest.get_modpath("default").."/we.lua")
dofile(minetest.get_modpath("default").."/wecommands.lua")
dofile(minetest.get_modpath("default").."/weinfinity.lua")
dofile(minetest.get_modpath("default").."/welimited.lua")
dofile(minetest.get_modpath("default").."/weshort.lua")
